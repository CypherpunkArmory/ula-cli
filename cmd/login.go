...
var loginCmd = &cobra.Command{
	Use:   "login",
	Short: "Login to holeulacli.",
	Long: "Login back into holeulacli.\n" +
...
func init() {
	...
	loginCmd.Flags().StringVarP(&username, "username", "u", "", "Your holeulacli.io username")
	loginCmd.Flags().StringVarP(&password, "password", "p", "", "Your holeulacli.io password")
}
...
func login(username string, password string) {
	...
	if err != nil {
		reportError("Couldn't write refresh token to config - are you able to write to ~/.config/holeulacli/ulacli.toml?", true)
	}
